...
document.getElementById('ilubl').onclick = (event) => {
    event.preventDefault();
    let municipalityId = window.location.pathname.replace('/Page8/','');let municipality = new TempApi.Municipality();municipality['mimage'] = {
